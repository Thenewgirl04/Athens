...
export function TeacherDashboard({ onLogout }: TeacherDashboardProps) {
  ...
  const navItems = [
    ...
    { label: "Create Course", icon: PlusCircle, to: "/create-course" },
...
const activityIconMap: Record<Activity["type"], ReactNode> = {
    ...
    <div className="max-w-7xl mx-auto p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <Avatar className="h-12 w-12">
          <AvatarFallback className="bg-blue-600 text-white">PR</AvatarFallback>
        </Avatar>
      </div>
